 ...
 * HeaderPagePart
 *
 * @ORM\Table(name="ismaserrano_portfoliobundle_header_page_parts")
 * @ORM\Entity
 */
class HeaderPagePart extends AbstractPagePart
{
    ...
    {
	return 'IsmaserranoPortfolioBundle:PageParts:HeaderPagePart/view.html.twig';
    }

    /**
     * Get the admin form type.
     *
     * @return \Ismaserrano\PortfolioBundle\Form\PageParts\HeaderPagePartAdminType
     */
    public function getDefaultAdminType()
    {
	return new \Ismaserrano\PortfolioBundle\Form\PageParts\HeaderPagePartAdminType();
    }
}
