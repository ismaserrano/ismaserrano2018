 ...
 *
 * @ORM\Entity
 * @ORM\Table(name="ismaserrano_portfoliobundle_image_page_parts")
 */
class ImagePagePart extends AbstractPagePart
{
    ...
    {
	return 'IsmaserranoPortfolioBundle:PageParts:ImagePagePart/view.html.twig';
    }

    /**
     * Get the admin form type.
     *
     * @return \Ismaserrano\PortfolioBundle\Form\PageParts\ImagePagePartAdminType
     */
    public function getDefaultAdminType()
    {
	return new \Ismaserrano\PortfolioBundle\Form\PageParts\ImagePagePartAdminType();
    }
}
