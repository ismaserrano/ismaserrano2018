...
/**
 * @ORM\Entity
 * @ORM\Table(name="ismaserrano_portfoliobundle_video_page_parts")
 */
class VideoPagePart extends AbstractPagePart
{
    ...
    {
	return "IsmaserranoPortfolioBundle:PageParts/VideoPagePart:view.html.twig";
    }
    ...
    {
	return new \Ismaserrano\PortfolioBundle\Form\PageParts\VideoPagePartAdminType();
    }
}
